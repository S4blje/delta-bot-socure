...
unlockemoji = "<:deltaunlock:1202252767524028436>"
lockemoji = "<:deltalock:1202252756430356512>"
plusemoji = "<:deltaplus:1202252770602926111>"
minusemoji = "<:deltaminus:1202252763720065046>"
channelemoji = "<:deltarename:1202252774256168991>"
unghostemoji = "<:deltaunghost:1202252794099138581>"
ghostemoji = "<:deltaghost:1202252780430176287>"
claimemoji = "<:deltaclaim:1202252784045666384>"
hammeremoji = "<:deltakick:1202252790655623188>"
manemoji = "<:deltainfo:1202252787820273741>" 
...
class voicemaster(commands.Cog):
   ...
   def create_interface(self, ctx: commands.Context) -> discord.Embed: 
     em = discord.Embed(color=self.bot.color, title="delta interface", description="> you can **control** the voicemaster interface with the buttons **below**")    
     em.set_author(name=ctx.guild.name, icon_url=ctx.guild.icon)
     em.add_field(name="Manage", value=f"{lockemoji} [`lock`](https://discord.gg/NMj58fsjEa) the voice channel\n{unlockemoji} [`unlock`](https://discord.gg/NMj58fsjEa) the voice channel\n{ghostemoji} [`hide`](https://discord.gg/NMj58fsjEa) the voice channel\n{unghostemoji} [`reveal`](https://discord.gg/NMj58fsjEa) the voice channel\n{channelemoji} [`rename`](https://discord.gg/NMj58fsjEa) the voice channel")
     em.add_field(name="Misc", value=f"{plusemoji} [`increase`](https://discord.gg/NMj58fsjEa) the user limit\n{minusemoji} [`decrease`](https://discord.gg/NMj58fsjEa) the user limit\n{claimemoji} [`claim`](https://discord.gg/NMj58fsjEa) the voice channel\n{manemoji} [`info`](https://discord.gg/NMj58fsjEa) of the channel\n{hammeremoji} [`moderate`](https://discord.gg/NMj58fsjEa) the voice channel")    
     return em
